The model parameters in the code are now set to obtain results from the endogenous model, so if one just run the code without any changes, this model will be build.
